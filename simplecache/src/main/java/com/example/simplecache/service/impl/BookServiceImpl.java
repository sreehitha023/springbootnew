package com.example.simplecache.service.impl;

import com.example.simplecache.entity.Book;
import com.example.simplecache.repository.BookRepository;
...
public class BookServiceImpl implements BookService {
    ...
    public Book updateBook(Book book) {
        bookRepository.updateBookName(book.getId(), book.getName());
